...
Contains a static methods called bigger_or_equal that compares
the size of the rectangle
Contains a class method that returns a square.
"""
...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """
        Static method that compares the size of the rectangle.

        Args:
            rect_1: instance of the first rectangle.
            rect_2: instance of the seconf rectangle.
